...
hold on, subplot(1,2,1), semilogy(prob_1,Loss_e,'k','LineWidth',1), xlabel('p_1 (Prob. of Solution 1)'), title('Relative losses')
hold on, subplot(1,2,2), plot(prob_1,Loss_e,'k','LineWidth',1), ylim([0 80]), xlim([0.997 1]), xlabel('p_1 (Prob. of Solution 1)'), title('Zoomed in: p_1 \approx 1')
